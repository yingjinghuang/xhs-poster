...
const zipSource = readFileSync(join(root, "app/zip.ts"), "utf8");
...
assert.match(pageSource, /manualTitle\.trim\(\) \|\| "XHS-Poster"/, "untitled exports should use a neutral XHS-Poster default name");
